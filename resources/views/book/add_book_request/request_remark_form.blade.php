<form method="post" id="request_remark_form" action="javascript:add_request_remark();" enctype="multipart/form-data">
    @csrf
    <div class="row g-4">
        <div class="col-lg-6">
                ...
                <div class="form-group">
                    ...
                    <div class="form-control-wrap">
                        <textarea class="form-control form-control-sm" id="remark" name="remark"
                            value="{{ $book ? $book->remarks : '' }}" required>{{ $book ? $book->remarks : '' }}</textarea>
                    </div>
                </div>
            </div>
