...
@section('content')
                        ...
                        <div class="nk-block nk-block-lg">
                            <div class="nk-block-between mb-4">
                                <div class="nk-block-head-content">
                                    <h4 class="nk-block-title">Borrow Book Requests</h4>
                                </div>
    ...
    <script>
        ...
        function save_request_remark() {
            ...
            let arr = [a, b];
            call_ajax_with_functions('', '{{ route('borrow_book_remark') }}', data, arr);
        }
        ...
        function edit_book_request(me) {
            ...
            arr = [a];
            call_ajax_modal_with_functions('{{ route('borrow_book_detail') }}', data, 'Add Remark To This Request ',
                arr);
        }
